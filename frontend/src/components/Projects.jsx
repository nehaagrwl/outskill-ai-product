      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-8">
          {profileData.projects.map((project, index) => {
            ...
            return (
              <Card 
                key={project.id} 
                className="group shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden"
              >
        ...
        <div className="mt-16 grid md:grid-cols-4 gap-6 text-center">
          <div className="p-6 bg-gray-50 rounded-xl">
            ...
            <div className="text-gray-600 text-sm">Funding Secured</div>
          </div>
          <div className="p-6 bg-gray-50 rounded-xl">
          ...
          <div className="p-6 bg-gray-50 rounded-xl">
            ...
            <div className="text-gray-600 text-sm">Global Utilities</div>
          </div>
          <div className="p-6 bg-gray-50 rounded-xl">
        ...
        <div className="mt-16 text-center">
          <div className="max-w-2xl mx-auto p-8 bg-gray-900 text-white rounded-2xl">
            <h3 className="text-2xl font-semibold mb-4">Interested in collaboration?</h3>
            <p className="text-gray-300 mb-6 leading-relaxed">
              I'm always open to discussing new opportunities and innovative projects 
              in product management and analytics.
            </p>
            <button 
