        ...
        <div className="relative">
          ...
          <div className="space-y-12">
            {profileData.experience.map((exp, index) => (
              ...
              >
                {/* Timeline dot */}
                <div className="absolute left-4 md:left-1/2 w-4 h-4 bg-gradient-to-r from-primary to-secondary rounded-full transform -translate-x-1/2 z-10 border-2 border-card shadow-lg"></div>
                    ...
                    <CardContent className="p-6">
                      <div className="mb-4">
                        <div className="flex items-start justify-between mb-2">
                          ...
                          <Badge variant="outline" className="ml-2 text-xs border-accent text-accent bg-accent/10">
                            Past
                          </Badge>
                        </div>
        ...
        <div className="mt-16 text-center">
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="p-6 bg-card rounded-xl shadow-lg border border-border">
              ...
              <div className="text-muted-foreground">Avg Revenue Growth</div>
            </div>
          </div>
        </div>
      </div>
