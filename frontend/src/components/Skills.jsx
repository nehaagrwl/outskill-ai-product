      ...
      <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="grid gap-3">
                  {category.skills.map((skill, skillIndex) => (
                    ...
                    >
                      ...
                      <span className="text-light-gray font-semibold text-sm">{skill}</span>
                    </div>
                  ))}
                </div>
              </CardContent>
        ...
        <div className="mt-16 p-8 bg-card rounded-2xl shadow-lg border-2 border-primary/20">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl font-semibold text-bright-white mb-4">
                Technical Proficiency
              </h3>
              <p className="text-light-gray leading-relaxed mb-6 font-medium">
              ...
              <div className="flex flex-wrap gap-2">
                {["Python", "SQL", "Tableau", "Looker", "Power BI", "A/B Testing", "Gen AI", "LLMs"].map((tool, index) => (
                  <Badge key={index} variant="outline" className="text-sm border-primary-bright text-bright-white hover:bg-primary/10 font-semibold">
                    {tool}
                  </Badge>
                ))}
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center p-4 bg-primary/10 rounded-xl border-2 border-primary/30">
                ...
                <div className="text-sm text-light-gray font-semibold">Core Strength</div>
              </div>
              <div className="text-center p-4 bg-secondary/10 rounded-xl border-2 border-secondary/30">
                ...
                <div className="text-sm text-light-gray font-semibold">Expert Level</div>
              </div>
              <div className="text-center p-4 bg-primary/10 rounded-xl border-2 border-primary/30">
                <div className="text-lg font-bold text-primary-bright mb-1">Team Leadership</div>
                <div className="text-sm text-light-gray font-semibold">Proven Track Record</div>
              </div>
              <div className="text-center p-4 bg-secondary/10 rounded-xl border-2 border-secondary/30">
                <div className="text-lg font-bold text-secondary-bright mb-1">Gen AI Tools</div>
                <div className="text-sm text-light-gray font-semibold">Current Focus</div>
              </div>
            </div>
          </div>
        </div>
