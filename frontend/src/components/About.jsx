      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            {/* Key Highlights */}
            <div>
              <h3 className="text-2xl font-medium text-foreground mb-6">Key Highlights</h3>
            ...
            {/* Certifications */}
            <div>
              <h3 className="text-2xl font-medium text-foreground mb-6">Certifications</h3>
              <div className="grid gap-3">
                {profileData.certifications.map((cert, index) => (
                  ...
                  >
                    <p className="text-muted-foreground font-medium">{cert}</p>
                  </div>
                ))}
              </div>
            </div>
